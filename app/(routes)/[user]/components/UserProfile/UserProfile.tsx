      ...
      <div className="flex flex-col items-center gap-2 mt-10 w-full px-5 z-10">
        ...
        <div className="flex flex-col gap-5 mt-10">
          {user.links.map((link) => (
            <div
              key={link.id}
              className="bg-cyan-900 text-white w-[400px] px-10 py-4 items-center justify-center hover:bg-violet-200 hover:text-violet-800 transition-all duration-200 rounded-full"
            >
              <Link
                href={link.link || ""}
                target="_blank"
